oncontextmenu = (e) => {
    ...
    if(rightmenudiv === null){
        ...
        menu.innerHTML = `<p>Arrange Icons</p><p>Line Up Icons</p> <hr></hr> <p>Paste</p><p>Paste Shortcut</p><p>Undo Delete</p> <hr></hr> <p>New</p> <hr></hr> <button onclick='menuerror("An error message to annoy you.")'>Properties</button>`
        }
...
function menuerror(errormessage){
    ...
    if(errormenudiv === null){
        ...
        menuer.innerHTML = `<div class='content-inside-95-error' style='width: 350px; height: auto;'> <div class='title-95' id='win'> <h1>Windows 95</h1><div><button onclick='closeerror()' id='win'><img src='./Images/Icons/close.svg' alt='X'  id='win'></button> </div> </div> <div class='content-inside-95-error-flex'> <img src='./Images/Icons/msg_warning-0.ico' style='width: 50px; height: 50px;'> <p>${errormessage}</p> </div> </div>`
